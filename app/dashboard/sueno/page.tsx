...
import { Moon, Plus, Clock, Edit, Trash2, X, Save, Calendar, Search } from 'lucide-react'
...
export default function SuenoPage() {
  ...
  const loadActivities = async () => {
    try {
      ...
      if (response.ok) {
        ...
        const sleepActivities = allActivities.filter((a: Activity) => a.type === 'sleep')
        setActivities(sleepActivities)
      }
    } catch (error) {
  ...
  useEffect(() => {
    if (selectedActivity && !isEditing) {
      ...
      setEditForm({
        type: selectedActivity.details?.type || 'siesta',
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      {filteredActivities.length === 0 ? (
        ...
        <div className="space-y-3">
          {filteredActivities.map((activity) => {
            const type = activity.details?.type || 'siesta'
            return (
              <motion.div
                key={activity.id}
                  ...
                  <div className="flex items-center gap-4 flex-1">
                    ...
                    <div className="flex-1">
                      <p className="font-semibold text-gray-800">
                        {type === 'siesta' ? 'Siesta' : 'Sueño Nocturno'}
                      </p>
                    ...
                    <div className="flex items-center gap-2">
                      <Button
                        ...
                        onClick={(e) => {
                          ...
                          setEditForm({
                            type: activity.details?.type || 'siesta',
      ...
      {/* Modal similar al de alimentación - código abreviado por espacio */}
      <AnimatePresence>
        {selectedActivity && (
          <motion.div
            initial={{ opacity: 0 }}
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    >
                      ...
                      <option value="nocturno">Sueño Nocturno</option>
                    </select>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-lg font-semibold text-gray-800">
                        {selectedActivity.details?.type === 'siesta' ? 'Siesta' : 'Sueño Nocturno'}
                      </p>
