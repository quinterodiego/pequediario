      ...
      <main className="container mx-auto px-4 py-12 md:py-20">
        ...
        <div className="text-center mb-16 animate-fade-in">
          <div className="inline-block mb-6">
            <span className="inline-flex items-center gap-2 bg-[linear-gradient(135deg,#F8D77E,#F2C94C_40%,#D6A63A)] text-white px-6 py-3 rounded-full text-sm font-semibold shadow-lg">
